...
<!-- Tech stack: Inicio -->
  ...
  <img src="https://skillicons.dev/icons?i=html,css,js,vue,tailwind,vite,flutter,php,laravel,java,python,mysql,postgres,git,github,vscode,docker,postman,filezilla&perline=8" />
<!-- Tech stack: Fin -->
